...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex flex-row items-center justify-center gap-2 px-6 py-5.5 lg:py-6.5 w-full  ">
        <NavLink to="/dashboard/view">
       <div className='w-full flex flex-col items-center font-bold justify-center  '>
       <Image className={'w-12 h-auto'} image={LOGO}/>
       <span className=' mt-2'>Fitness First</span>
       </div>
        </NavLink>
    ...
    open && 'rotate-180'
              ...
              <li>
                ...
                >
                  <svg  className='fill-current' height="20" width="20" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  
	 viewBox="0 0 330 330"  >
<g id="XMLID_350_">
		...
		C330,306.716,323.284,300,315,300z"/>
              ...
              <li>
                <NavLink
                  to="/fingerprint/view"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('fingerprint') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <FingerPrint/>
                  FingerPrint
